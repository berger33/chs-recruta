...
class SessionToken(Base):
    ...
    revoke_reason:Mapped[str]=mapped_column(String(160),default="")
    ip_address:Mapped[str]=mapped_column(String(64),default="")
    user_agent:Mapped[str]=mapped_column(String(500),default="")
    device_name:Mapped[str]=mapped_column(String(160),default="")
    mfa_verified:Mapped[bool]=mapped_column(Boolean,default=False,index=True)
    authenticated_at:Mapped[datetime]=mapped_column(DateTime,default=utcnow)
    privileged_grant_id:Mapped[int|None]=mapped_column(ForeignKey("privileged_access_grants.id",ondelete="SET NULL"),nullable=True,index=True)
